...
public class HttpClientUtilsTJH {
...
//        return sendRequest(httpGet, charset, (response, args) -> EntityUtils.toString(response.getEntity(), (String) args[0]));
        return sendRequest(httpGet, charset, new GetEntityValue<String>() {
            @Override
            public String getValue(CloseableHttpResponse response, Object... args) throws Exception {
                return EntityUtils.toString(response.getEntity(), (String) args[0]);
            }
        });
    }
